...
//        DataStream<Trade> map2 = map1.partitionCustom(new MyPartitioner(), "cardNum");
        DataStream<Trade> map2 = map1.partitionCustom(new MyTradePartitioner(), new KeySelector<Trade, Trade>() {
            @Override
            public Trade getKey(Trade value) throws Exception {
                return value;
            }
        });
//        map2.print("map2");
